...
\subsection{\texorpdfstring{Thesis supervisor \hfill Mar 2026-Present
day}{Thesis supervisor Mar 2026-Present day}}\label{thesis-supervisor-mar-2026-present-day}
...
\item
  ...
  \item
    Erasmus School of Social and Behavioural Sciences, Department of
    Public Administration and Sociology (DPECS)
  \end{itemize}
\end{itemize}

\subsection{\texorpdfstring{(Voluntary) Fellow \hfill Sept.~2025-Present
day}{(Voluntary) Fellow Sept.~2025-Present day}}\label{voluntary-fellow-sept.-2025-present-day}
...
\subsection{\texorpdfstring{Visiting Fellow \hfill March 2026-April
2026}{Visiting Fellow March 2026-April 2026}}\label{visiting-fellow-march-2026-april-2026}
...
\hfill Oct 2023-Sept
2025}{Teaching Assistant in Public Policies Oct 2023-Sept 2025}}\label{teaching-assistant-in-public-policies-oct-2023-sept-2025}
...
\item
  ...
  and a Protocol Blueprint for Cross-Country Applications. Under review
  in \emph{Quality \& Quantity.}
\end{enumerate}
...
\item
  ...
  Countries. Under review in \emph{International Journal of Public
  Opinion Research}.
\end{enumerate}
...
\item
  ...
  on Instagra,. (with Decadri, S., Negri, F.)
...
\item
  ...
  Journalism. Empirical evidence from Italy (with Valeriani, A., Garusi,
  D., Splendore, S.)
...
\item
  \textbf{English}, C2.
\item
  \textbf{Dutch,} C1 speaking, B2 writing, currently studying for full
  C1.
\end{itemize}
